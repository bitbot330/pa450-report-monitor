...
def test_build_monitoring_guidance_identifies_current_csv_distribution_candidates() -> None:
    context = build_context(Path(__file__).resolve().parent / "fixtures" / "20260512_report.csv")
...
def test_build_monitoring_guidance_reports_insufficient_data_for_missing_columns() -> None:
...
def test_analysis_prompt_prevents_listing_every_top_sources_row() -> None:
